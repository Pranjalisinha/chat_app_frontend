...
export default function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white dark:bg-gray-900 transition-colors duration-200">
      <nav className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="mt-3 mb-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-lg shadow-black/5">
